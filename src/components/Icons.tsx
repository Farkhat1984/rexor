...
export function IconHeart({ className = "w-6 h-6", filled = false }: { className?: string; filled?: boolean }) {
  return (
...
export function IconFilter({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function IconChevronLeft({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function IconTelegram({ className = "w-6 h-6" }: { className?: string }) {
  return (
